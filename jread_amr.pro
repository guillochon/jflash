...
if (var_name NE 'none' AND var_name NE 'all ') then begin
...
if (file_type EQ 1) then begin 
  ...
  if (FLASH3) then begin
    ...
    if Keyword_set(verbose) then begin 
      print,'in jread_amr.pro, next help is on particles'
